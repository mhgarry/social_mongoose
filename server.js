...
const mongoose = require('mongoose'); // bring in mongoose package
const routes = require('./routes'); // bring in all routes

const app = express(); // create an express app server
const PORT = process.env.PORT || 1337; // set the port to 1337
console.log(PORT);
...
}); // open the app to listen for a request on port 1337
